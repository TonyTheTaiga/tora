                    ...
                    transformers: [
                        {
                            line(node, line) {
                                ...
                                node.children.unshift({
                                    ...
                                    properties: {
                                        class: "line-number",
                                        style: "color: var(--color-ctp-overlay0); user-select: none; margin-right: 1em; display: inline-block; width: 2ch; text-align: right;",
                                    },
                                    children: [
                                        {
                                            type: "text",
...
>
    <div class="w-full max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex flex-col items-center text-center text-ctp-text">
            <div
                class="fill-ctp-blue w-full max-w-xs sm:max-w-sm mb-8 sm:mb-12"
            >
                <Logo />
            </div>
                    ...
                    >
                        ...
                        >
                            <div class="flex space-x-2">
                                <div
                                    class="w-3 h-3 rounded-full bg-ctp-blue"
                                ></div>
                                <div
                                    class="w-3 h-3 rounded-full bg-ctp-blue"
                                ></div>
