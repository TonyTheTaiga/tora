...
### Changed
- BREAKING: `tmetric` signature updated to `tmetric(name, value, step: int)`; `step` is now required.

## [0.0.11] - 2025-09-01

### Changed
- Default API base URL updated to `https://api.toracker.com`.
- If you override via `TORA_BASE_URL`, no changes are required.
