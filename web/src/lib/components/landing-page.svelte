<script lang="ts">
  ...
  const copy: Record<LangKey, CopyContent> = {
    en: {
      ...
      feature1Desc: "Skip the hassle. Integrate Tora in minutes and start seeing results. Its design works with your existing tools, guaranteeing a smooth, zero-downtime transition.",
      feature2Title: "Dive into Data with Stunning Visuals!",
      feature2Desc: "Experience your data like never before! Interactive charts and real-time metrics bring your experiments to life, making it easy to spot trends and make data-driven decisions.",
      feature3Title: "AI: Your Strategic Advantage",
      feature3Desc: "Harness the power of AI to optimize your models. Tora's intelligent analysis provides key insights, helping you fine-tune parameters, detect anomalies, and maximize performance.",
      feature4Title: "MLOps: Together, Smarter",
      feature4Desc: "Build a thriving MLOps community. Tora's collaborative workspaces empower your team to share knowledge, manage experiments, and achieve more, together."
    },
    ja: {
...
>
  <div class="h-2/3 flex flex-col">
    ...
    <div class="flex-1 flex justify-end p-2">
      <div class="w-1/3 flex flex-col z-10 p-4 opacity-75 justify-center">
